...
public class BattleshipGUIUtils extends JFrame {
	...
	public static void fieldsizeError() {
		JOptionPane.showMessageDialog(BattleshipGUI.getMainPanel(), "Bitte eine Feldgroesse zwischen 1 und 26" +
	...
	public static void won() {
		Object[] options = {"YAY!"};
		JOptionPane.showOptionDialog(null, "Glueckwunsch, du hast alle Schiffe des Bots versenkt! Du hast gewonnen!",
